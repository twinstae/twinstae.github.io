...
멋진 성과였습니다. 이제 손으로 하나하나 스크린샷을 찍을 필요가 없었습니다. 보안과 웹에 대한 지식을 활용해서 o백업 과정을 자동화했으니까요. 메일은 모두 json과 HTML 파일이었기 때문에 용량도 8mb 정도 밖에 되지 않았습니다. (물론 이미지는 1기가를 넘었지만. 스크린샷은 8기가가 넘었습니다!)

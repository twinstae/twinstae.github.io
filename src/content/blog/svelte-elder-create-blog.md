...
tags: ["Svelte", "Elder.js", "GitHub Pages", "Blog"]
---
...
여기서 {{keyword}}JAM Stack{{/keyword}}이 등장합니다. 미리 가능한 페이지들을 정적(static) HTML 파일로 만들어서 CDN(콘텐츠 배달 네트워크)에 올려놓고, 추가로 필요한 데이터만 작은 API 서버에서 받아오게 하는 것이죠.
